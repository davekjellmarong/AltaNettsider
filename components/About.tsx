              ...
              <div className="relative grid md:grid-cols-3 gap-6 text-center">
                <div className="flex flex-col items-center">
                  <div className="w-16 h-16 bg-alta-blue/10 rounded-full flex items-center justify-center mb-3">
                    <svg
                      className="w-8 h-8 text-alta-blue"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                  ...
                  <h3 className="font-semibold text-alta-dark">
                    Basert i Alta
                  </h3>
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          <div className="text-center">
            <p className="text-gray-800 text-lg leading-relaxed mb-6">
              Jeg heter Dave og lager moderne nettsider for lokale bedrifter i
              Alta og Finnmark. Som liten aktør forstår jeg utfordringene små
              bedrifter møter, og lager enkle løsninger som faktisk gir deg
              flere kunder.
            </p>
            <p className="text-gray-700 leading-relaxed mb-8">
              Basert i Alta kjenner jeg området og hvordan lokale bedrifter
              tenker. Jeg tror på enkle løsninger som bare fungerer, uten masse
              teknisk pirk eller unødvendig kompleksitet.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white/70 rounded-lg p-6 border border-gray-100 shadow-sm">
              <div className="flex items-center mb-3">
                <div className="w-10 h-10 bg-alta-blue/10 rounded-lg flex items-center justify-center mr-3">
                  <svg
                    className="w-5 h-5 text-alta-blue"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                ...
                <h4 className="text-xl font-semibold text-alta-blue">
                  Mitt mål
                </h4>
              </div>
              <p className="text-gray-700">
                At din bedrift skal få flere kunder gjennom en{" "}
                <Link
                  href="/nettsider-for-lokale-bedrifter"
                  className="text-alta-blue hover:underline font-medium"
                >
                  nettside som faktisk fungerer for deg
                </Link>
                .
              </p>
            </div>
            <div className="bg-white/70 rounded-lg p-6 border border-gray-100 shadow-sm">
              ...
              <p className="text-gray-700">
                Ingen oppblåst teknisk språk. Bare ærlig rådgivning og{" "}
                <Link
                  href="/nettsider-for-lokale-bedrifter"
                  className="text-alta-blue hover:underline font-medium"
                >
