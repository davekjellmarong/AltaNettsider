      ...
      <div className="container-custom">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Interessert i våre tjenester? Send oss en melding, så vil vi kontakte deg så snart som mulig for å diskutere ditt prosjekt.
          </p>
        </div>

        <div className="grid md:grid-cols-2 gap-12">
          <div className="bg-white rounded-lg shadow-sm p-8">
            <h3 className="text-xl font-semibold text-alta-dark mb-6">Send oss en melding</h3>
            <form className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label htmlFor="name" className="text-sm font-medium text-gray-700">Navn</label>
                  <Input 
                    id="name" 
                    type="text" 
              ...
              <div className="space-y-2">
                <label htmlFor="subject" className="text-sm font-medium text-gray-700">Emne</label>
                <Input 
                  id="subject" 
                  type="text" 
              ...
              <div className="space-y-2">
                <label htmlFor="message" className="text-sm font-medium text-gray-700">Melding</label>
                <Textarea 
                  id="message" 
          ...
          <div className="space-y-8">
            <div>
              <h3 className="text-xl font-semibold text-alta-dark mb-4">Kontaktinformasjon</h3>
            ...
            <div>
              <h3 className="text-xl font-semibold text-alta-dark mb-4">Åpningstider</h3>
              <div className="space-y-2">
                <div className="flex justify-between">
                  <span className="text-gray-600">Mandag - Fredag</span>
                  <span className="text-gray-700 font-medium">09:00 - 17:00</span>
                </div>
                <div className="flex justify-between">
