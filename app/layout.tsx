...
const structuredData = {
  ...
  "@type": "LocalBusiness",
  "name": "AltaNettsider",
  "description": "Profesjonelle nettsider for lokale bedrifter i Alta og Finnmark",
  "url": "https://altanettsider.no",
  "telephone": "+47-412-34-567",
  "email": "dave@altanettsider.no",
  "address": {
    "@type": "PostalAddress",
  ...
  "sameAs": [
    "https://www.linkedin.com/in/davekjellmarong"
  ],
  "hasOfferCatalog": {
    "@type": "OfferCatalog",
...
export const metadata: Metadata = {
  ...
  generator: "v0.dev",
  keywords: "nettsider for lokale bedrifter, nettsider Alta, nettsider Finnmark, små bedrifter nettside, lokal bedrift nettside, web utvikler Alta",
  ...
  openGraph: {
    ...
    title: "Nettsider for lokale bedrifter i Alta - AltaNettsider",
    description: "Profesjonelle nettsider for lokale bedrifter i Alta og Finnmark. Fra 4,900 kr. Gratis forslag uten forpliktelser.",
    images: [
      {
        url: "/og-image.png",
        width: 1200,
  ...
  twitter: {
    ...
    description: "Profesjonelle nettsider for små bedrifter i Alta og Finnmark. Fra 4,900 kr.",
    images: ["/og-image.png"],
  ...
  icons: {
    ...
    shortcut: "data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'><circle cx='50' cy='50' r='40' fill='%232563eb'/><text x='50' y='58' font-family='Arial,sans-serif' font-size='32' font-weight='bold' fill='white' text-anchor='middle'>A</text></svg>",
    apple: "data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'><circle cx='50' cy='50' r='40' fill='%232563eb'/><text x='50' y='58' font-family='Arial,sans-serif' font-size='32' font-weight='bold' fill='white' text-anchor='middle'>A</text></svg>",
  },
};
